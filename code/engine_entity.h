...
inline b32 IsSet(sim_entity *Entity, u32 Flag)
{
...
inline void AddFlags(sim_entity *Entity, u32 Flag)
{
    Entity->Flags |= Flag;
}

inline void ClearFlags(sim_entity *Entity, u32 Flag)
{
    Entity->Flags &= ~Flag;
}
...
inline r32 GetStairGround(sim_entity *Entity, v3 AtGroundPoint)
{
