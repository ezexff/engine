# C++ Game Engine
Кросплатформерная структура проекта (слой платформы и игровой код независимы друг от друга) <br>
Что реализовано (Win32 платформа):
*	Два батника: для компиляции (при помощи MSVC) и отладки (через Vistual Studio) C++ кода
